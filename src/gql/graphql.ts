...
export type City = Node & {
  ...
  languageCode: LanguageCode;
  name: Scalars['String']['output'];
  translations: Array<Maybe<CityTranslation>>;
  updatedAt: Scalars['DateTime']['output'];
};
...
export type CityTranslation = Node & {
...
export type Mutation = {
  ...
  removeOrderLines: RemoveOrderItemsResult;
...
export type OrderFilterParameter = {
  ...
  paymentUrl?: InputMaybe<StringOperators>;
...
export type OrderSortParameter = {
  ...
  paymentUrl?: InputMaybe<SortOrder>;
...
export enum Permission {
  ...
  /** Grants permission to create SubCategory */
  ...
  /** Grants permission to create Wheel */
  ...
  /** Grants permission to delete SubCategory */
  ...
  /** Grants permission to delete Wheel */
  ...
  /** Grants permission to read SubCategory */
  ...
  /** Grants permission to read Wheel */
  ReadWheel = 'ReadWheel',
  ...
  /** Grants permission to update SubCategory */
  ...
  /** Grants permission to update Wheel */
...
export type Query = {
  ...
  getStoreCities?: Maybe<Array<City>>;
  getSuperBanners: SuperBannerList;
  ...
  selectedPromotion: Wheel;
  wheelPromotions?: Maybe<Array<Maybe<Wheel>>>;
};
...
export type QueryGetBannersArgs = {
  input?: InputMaybe<BannerListOptions>;
};


export type QueryGetStoreCitiesArgs = {
  countryId?: InputMaybe<Scalars['ID']['input']>;
};


export type QueryGetSuperBannersArgs = {
  options?: InputMaybe<SuperBannerListOptions>;
};
...
export type QuerySelectedPromotionArgs = {
  id: Scalars['ID']['input'];
};
...
export type SuperBanner = Node & {
  __typename?: 'SuperBanner';
  createdAt: Scalars['DateTime']['output'];
...
export type SuperBannerFilterParameter = {
  createdAt?: InputMaybe<DateOperators>;
...
export type SuperBannerList = PaginatedList & {
  __typename?: 'SuperBannerList';
  items: Array<SuperBanner>;
  totalItems: Scalars['Int']['output'];
};

export type SuperBannerListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<SuperBannerFilterParameter>;
  /** Specifies whether multiple "filter" arguments should be combines with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>;
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>;
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<SuperBannerSortParameter>;
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>;
};

export type SuperBannerSortParameter = {
  createdAt?: InputMaybe<SortOrder>;
  id?: InputMaybe<SortOrder>;
  updatedAt?: InputMaybe<SortOrder>;
  url?: InputMaybe<SortOrder>;
...
export type Wheel = Node & {
  __typename?: 'Wheel';
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  promotion: Promotion;
  timeView: Scalars['String']['output'];
  updatedAt: Scalars['DateTime']['output'];
};
...
export type CheckMeQuery = { __typename?: 'Query', me?: { __typename?: 'CurrentUser', id: string, identifier: string, channels: Array<{ __typename?: 'CurrentUserChannel', id: string }> } | null };
