    ...
    <section>
      ...
      <div>
        <div className="relative overflow-x-auto  sm:rounded-lg">
          ...
          {!data.length && (
            <div className="flex justify-center  text-xl text-gray-600 mt-6 italic">
              {" "}
