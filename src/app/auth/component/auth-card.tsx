...
function SubmitButton({ login }: { login: boolean }) {
  ...
  return (
    <button
      ...
      className="flex w-full bg-custom-wezly-primary justify-center rounded-md  px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-cyan-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    >
      {" "}
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm m-auto">
          <div className="w-full flex justify-center">
            <svg
              ...
              className="w-3/6 text-custom-wezly-primary"
            >
              <path
                className="cls-1"
